...
describe('Blower module', () => {
  ...
  test('Should create an array with 75 ball objects',async (done) => {
    let el = document.createElement('canvas');
    let blower = new Blower(el);
  ...
  test('Should have mechanism for starting the animation', async (done) => {
    let el = document.createElement('canvas');
    let blower = new Blower(el);
  ...
  test('Should have mechanism for stopping the animation', async (done) => {
    let el = document.createElement('canvas');
    let blower = new Blower(el);
